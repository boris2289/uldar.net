...
const routes: Routes = [
  ...
  { path: 'questions/:questionSlug/', component: QuestionDetailComponent },
  { path: 'questions/:questionSlug/edit', component: EditQuestionComponent, canActivate: [AuthGuardService], },
